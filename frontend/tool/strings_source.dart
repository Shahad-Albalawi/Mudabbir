...
class AppStrings {
  ...
  static String get validationEmailRequired =>
      _isEnglish ? 'Email is required' : 'البريد الإلكتروني مطلوب';
  static String get validationEmailInvalid =>
      _isEnglish ? 'Enter a valid email address' : 'أدخل بريد إلكتروني صحيح';
  static String get validationPasswordRequired =>
      _isEnglish ? 'Password is required' : 'كلمة المرور مطلوبة';
  static String get validationPasswordMinLength => _isEnglish
      ? 'Password must be at least 8 characters'
      : 'كلمة المرور يجب أن تكون 8 أحرف على الأقل';
  static String get validationFirstNameRequired =>
      _isEnglish ? 'First name is required' : 'الاسم الأول مطلوب';
  static String get validationPasswordMismatch => _isEnglish
