...
class AnalysisNotifier extends StateNotifier<AnalysisState> {
  ...
  Future<void> retry() async {
    ...
    await _ref.read(statisticsProvider.notifier).loadStatistics(force: true);
  ...
  Future<void> _rebuild(StatisticsState statistics) async {
    ...
    if (statistics.errorMessage != null) {
    ...
    if (_lastStatsFingerprint == statistics.analysisFingerprint &&

        state.error == null &&

        !state.isLoading &&

        state.financialHealthRating.isNotEmpty) {
    ...
    try {
      ...
      if (base.error != null) {
        ...
        state = AnalysisState(isLoading: false, error: base.error);
      ...
      _lastStatsFingerprint = statistics.analysisFingerprint;
