...
class AppStrings {
  ...
  static String get authForgotPasswordTitle => _t.authForgotPasswordTitle;
  static String get authForgotPasswordBody => _t.authForgotPasswordBody;
  static String get authForgotPasswordSubmit => _t.authForgotPasswordSubmit;
  static String get authForgotPasswordSent => _t.authForgotPasswordSent;
  static String get authResetPasswordTitle => _t.authResetPasswordTitle;
  static String get authResetPasswordBody => _t.authResetPasswordBody;
  static String get authResetCodeLabel => _t.authResetCodeLabel;
  static String get authResetCodeRequired => _t.authResetCodeRequired;
  static String get authResetCodeInvalid => _t.authResetCodeInvalid;
  static String get authBackToLogin => _t.authBackToLogin;
  static String get biometricLockTitle => _t.biometricLockTitle;
  static String get biometricLockSubtitle => _t.biometricLockSubtitle;
  static String get biometricUnlockButton => _t.biometricUnlockButton;
  static String get biometricUnlockReason => _t.biometricUnlockReason;
  static String get biometricSettingsLabel => _t.biometricSettingsLabel;
  static String get biometricAvailable => _t.biometricAvailable;
  static String get biometricNotEnrolled => _t.biometricNotEnrolled;
  static String get biometricNotSupported => _t.biometricNotSupported;
  static String get biometricUnavailable => _t.biometricUnavailable;
  static String get biometricEnabledSuccess => _t.biometricEnabledSuccess;
  static String get biometricDisabledSuccess => _t.biometricDisabledSuccess;
