...
class ChallengeService {
  ...
  Future<List<ChallengeModel>> getChallenges() async {
    debugPrint('[Challenge API] GET /challenges - starting');
    try {
      ...
      debugPrint('[Challenge API] GET /challenges - Error: $e\n$stack');
      rethrow;
    }
  }
  ...
  Future<ChallengeModel> inviteUser({
    ...
    for (final endpoint in endpoints) {
      debugPrint('[Challenge API] POST $endpoint invite for $sanitizedEmail');
      try {
        final response = await _dioClient.dio.post(
          endpoint,
