...
import 'package:mudabbir/persentation/invite/invite_view.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildStatCard(
            context: context,
            title: PlannerStrings.navPlanner,
            icon: CupertinoIcons.square_grid_2x2_fill,
            isPrimary: false,
            onTap: () => homeViewModel.changeNavBar(3),
          ),
          const SizedBox(height: AppSize.s12),
          _buildStatCard(
            context: context,
            title: AppStrings.budgetString,
            icon: CupertinoIcons.creditcard_fill,
            isPrimary: false,
            onTap: () => getIt<NavigationService>().navigate(BudgetView()),
          ),
        ],
      ),
    );
