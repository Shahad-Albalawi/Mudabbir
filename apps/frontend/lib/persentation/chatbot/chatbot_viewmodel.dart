...
import 'package:mudabbir/persentation/resources/chatbot_llm_prompt.dart';
...
class ChatbotViewModel extends BaseViewModel {
  ...
  Future<Map<String, dynamic>> _getAllDatabaseContext() async {
    ...
    try {
      ...
      debugPrint('Error fetching database context: $e');
    }
  ...
  Future<String> _sendToBackend(String content) async {
    ...
    debugPrint('[Chatbot API] All retries failed: $lastError');
