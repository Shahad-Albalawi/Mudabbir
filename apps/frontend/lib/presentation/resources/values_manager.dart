/// Consistent spacing values for margins across the app.
class AppMargin {
...
/// Consistent padding values for UI elements (8pt grid system).
class AppPadding {
...
/// Standard sizes for borders, icons, and components.
class AppSize {
